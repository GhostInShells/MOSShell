# Superseded — legacy screen-node design (2026-07-24 → 2026-08-03)

> 本文档是 screen-node 的**旧设计**（Decision 1–11 + S1–S3 实现记录），于 2026-09-13
> 被整体重设计取代，原样保留供决策轨迹回溯。**运行原型仍在 `nodes/screens/qt_screen`，
> 不改不删。** 当前结论见同目录 `FEATURE.md`，重设计的碰撞轨迹见
