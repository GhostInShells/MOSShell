...
class ChannelRuntimeImpl(ChannelRuntime):
    ...
    def __init__(self, channel: Channel):
        ...
        self._running_tasks: Set[CommandTask] = set()
    ...
    async def _prepend(self, tasks: List[CommandTask]) -> None:
        for task in tasks:
            task.set_state('pending')
