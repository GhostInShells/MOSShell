...
app.add_typer(manifest.app, name="manifest", short_help="MOSS workspace manifest tools")
app.add_typer(modes.mode_app, name="modes", short_help="MOSS runtime modes manager")
