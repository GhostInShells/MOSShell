...
def demo_items() -> list[dict]:
    """A pre-built scene mirroring the verified lab pool: four groups, several items."""
    return [
        {"id": "term", "url": demo_page("term", "#5af"), "label": "terminal", "group": "code"},
        {"id": "edit", "url": demo_page("edit", "#5fa"), "label": "editor", "group": "code"},
        {"id": "chat", "url": demo_page("chat", "#fa5"), "label": "chat", "group": "code"},
        {"id": "dsh", "url": demo_page("dsh", "#f5a"), "label": "dashboard", "group": "media"},
        {"id": "cam1", "url": demo_page("cam1", "#5ff"), "label": "cam 1", "group": "media"},
        {"id": "cam2", "url": demo_page("cam2", "#a5f"), "label": "cam 2", "group": "media"},
        {"id": "spec", "url": demo_page("spec", "#ffa"), "label": "spec", "group": "docs"},
        {"id": "note", "url": demo_page("note", "#faa"), "label": "note", "group": "docs"},
    ]
